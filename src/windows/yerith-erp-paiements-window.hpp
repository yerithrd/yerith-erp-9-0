/*
 * yerith-erp-paiements-window.hpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */

#ifndef SRC_YERITH_HISTORIQUE_PAIEMENTS_WINDOW_HPP_
#define SRC_YERITH_HISTORIQUE_PAIEMENTS_WINDOW_HPP_


#include "../../ui_yerith-erp-paiements-window.h"
...
class YerithPaiementsWindow : public YerithWindowsCommons,
    					      private Ui_YerithPaiementsWindow,
...
public:
    ...
    void lister_les_elements_du_tableau(YerithSqlTableModel &paiementsTableModel);
...
public slots:
    ...
    void resetFilter(YerithSqlTableModel *historiquePaiementsTableModel);
...
private:
    ...
    YerithSqlTableModel *_curPaiementsTableModel;
};


#endif /* SRC_YERITH_HISTORIQUE_PAIEMENTS_WINDOW_HPP_ */
