...
void YerithCreerGroupeDeClientsWindow::reset_window_widgets_modification_Bit()
{
    lineEdit_creer_groupe_clients_reference_groupe->Set_widget_modified(false);
    lineEdit_creer_groupe_clients_designation->Set_widget_modified(false);
    lineEdit_creer_groupe_clients_maximum_de_membres->Set_widget_modified(false);


    comboBox_creer_groupe_clients_programme_de_fidelite_de_clients->Set_widget_modified(false);

    textEdit_creer_groupe_clients_description_groupe->Set_widget_modified(false);
...
void YerithCreerGroupeDeClientsWindow::rendreInvisible()
{
    ...
    else
    {
        ...
        (QObject::tr("VOUS étiez entrain de créer 1 Groupe de clients.\n"
        ...
        (QObject::tr("Vous avez annulé(e) 1 création d'1 Groupe de clients !"));

        _Cancel_MODIFICATION_request_Object
        ->Set_Window__MODIFICATION_CANCELLATION_TITLE
        (QObject::tr("ANNULER 1 création d'1 Groupe de clients !"));
