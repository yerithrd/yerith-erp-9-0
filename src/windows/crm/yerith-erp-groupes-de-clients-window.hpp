/*
 * yerith-erp-groupes-de-clients-window.hpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */

#ifndef YERITH_ERP_GROUPES_DE_CLIENTS_WINDOW_HPP_
#define YERITH_ERP_GROUPES_DE_CLIENTS_WINDOW_HPP_

#include "../../../ui_yerith-erp-groupes-de-clients-window.h"
...
class YerithGroupesDeClientsWindow : public YerithWindowsCommons,
    								 private Ui_YerithERPGroupesDeClientsWindow,
...
public:
	...
	YerithGroupesDeClientsWindow();

    virtual ~YerithGroupesDeClientsWindow();
...
private slots:
    ...
    void supprimer_PLUSIEURS_groupes_de_clients(YerithSqlTableModel &
                                                aClientGroupTableModel);

    void supprimer_groupe_de_clients();

    void afficher_groupes_de_clients(YerithSqlTableModel &
                                     aClientGroupTableModel);
...
#endif /* YERITH_ERP_GROUPES_DE_CLIENTS_WINDOW_HPP_ */
