/*
 * yerith-erp-sortir-liststocks-window.cpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */
#include"yerith-erp-sortir-liststocks-window.hpp"
...
YerithSortirListStocksWindow::YerithSortirListStocksWindow()
:YerithWindowsCommons(),
 _logger(new YerithLogger("YerithSortirListStocksWindow"))
{
	_windowName = YerithMainWindow::get_TRANSLATED_WindowName("stocks à sortir ou à transférer");
    ...
    setYerithTableView_FROM_WINDOWS_COMMONS(tableView_list_stocks);
...
void YerithSortirListStocksWindow::listStocks(YerithSqlTableModel &aSqlTableModel)
{
	retranslateUi(this);
