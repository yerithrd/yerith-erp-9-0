/*
 * YERITH_TABLEAUX_DE_BORDS_quantite_max_moindre.cpp
 *
...
void YerithTableauxDeBordWindow::quantite_max_benefices(QString fileName,
                                                        QString fieldId, int size)
{
    ...
    //QDEBUG_STRING_OUTPUT_2("YerithTableauxDeBordWindow::quantite_max_benefices - strQuery", strQuery);
    ...
    QList < Yerith_MAP_COMPLEX_Item * >field_id_valueTOmarge_beneficiaire;
...
void YerithTableauxDeBordWindow::quantite_moindre_benefices(QString fileName,
                                                            QString fieldId,
                                                            int size)
{
...
void YerithTableauxDeBordWindow::quantite_max_stats(QString fileName,
                                                    QString fieldId,
                                                    int size,
                                                    bool service /* = false */)
{
...
void YerithTableauxDeBordWindow::quantite_moindre_stats(QString fileName, QString fieldId, int size, bool service	/* = false */
                                                       )
{
