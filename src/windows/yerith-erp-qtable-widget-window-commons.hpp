...
#ifndef SRC_YERITH_ERP_QTABLE_WIDGET_WINDOWS_COMMONS_HPP_
#define SRC_YERITH_ERP_QTABLE_WIDGET_WINDOWS_COMMONS_HPP_
...
class YerithQTableWidgetWindowsCommons : public YerithWindowsCommons
{
	Q_OBJECT

public:

    inline YerithQTableWidgetWindowsCommons(const QString &anOutput_print_pdf_latexFileNamePrefix = "")
    :YerithWindowsCommons(anOutput_print_pdf_latexFileNamePrefix),
    ...
    virtual inline ~YerithQTableWidgetWindowsCommons()
    {
    }
...
protected slots:
    ...
    virtual inline void imprimer_UNE_LISTE_JUSQUAU_selectionne_WITH_A_YERITH_PROGRESS_BAR()
    {
        YerithProgressBar(this)(this,
                                &YerithQTableWidgetWindowsCommons::imprimer_UNE_LISTE_JUSQUAU_selectionne);
    }
...
#endif /* SRC_YERITH_ERP_QTABLE_WIDGET_WINDOWS_COMMONS_HPP_ */
