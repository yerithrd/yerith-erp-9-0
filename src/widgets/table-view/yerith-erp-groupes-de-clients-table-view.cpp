/*
 * yerith-erp-groupes-de-clients-table-view.cpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */


#include "yerith-erp-groupes-de-clients-table-view.hpp"
...
void YerithERPGroupesDeClientsTableView::lister_les_elements_du_tableau(YerithSqlTableModel &tableModel)
{
...
void YerithERPGroupesDeClientsTableView::currentChanged(const QItemSelection &
                                                        selected,
...
void YerithERPGroupesDeClientsTableView::selectionChanged(const QItemSelection &
                                                          selected,
                                                          const QItemSelection &
                                                          deselected)
{
    ...
    YerithGroupesDeClientsWindow *client_group_window =
                    curAllWindows->_groupesDeClientsWindow;
