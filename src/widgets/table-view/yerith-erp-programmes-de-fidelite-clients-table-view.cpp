/*
 * yerith-erp-programmes-de-fidelite-clients-table-view.cpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */


#include "yerith-erp-programmes-de-fidelite-clients-table-view.hpp"
...
void YerithERPProgrammesDeFideliteClientsTableView::
...
void YerithERPProgrammesDeFideliteClientsTableView::selectionChanged(const
                                                                     QItemSelection
                                                                     & selected,
                                                                     const
                                                                     QItemSelection
