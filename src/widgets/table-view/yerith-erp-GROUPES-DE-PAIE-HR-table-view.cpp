/*
 * yerith-erp-GROUPES-DE-PAIE-HR-table-view.cpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */

#include "yerith-erp-GROUPES-DE-PAIE-HR-table-view.hpp"
...
void YerithERPGroupesDePaieHRTableView::
		lister_les_elements_du_tableau(YerithSqlTableModel &tableModel)
{
    ...
    YERITH_SET_LAST_TABLE_VIEW_SELECTED_ROW_ID(curAllWindows,
                                               curAllWindows->_GROUPES_DE_PAIE_Window)

    resizeColumnsToContents();

    curAllWindows->_GROUPES_DE_PAIE_Window->handle_some_actions_tools_enabled();
}


void YerithERPGroupesDePaieHRTableView::selectionChanged(const QItemSelection &selected,
