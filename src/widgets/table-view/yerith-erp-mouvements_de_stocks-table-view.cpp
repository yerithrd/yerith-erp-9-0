/*
 * yerith-erp-mouvements_de_stocks-table-view.cpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */


#include "yerith-erp-mouvements_de_stocks-table-view.hpp"
...
void YerithERPMouvementsDeStocksTableView::lister_les_elements_du_tableau(YerithSqlTableModel &tableModel)
{
            ...
            case QVariant::Int:
                ...
                if (!YerithUtils::isEqualCaseInsensitive(curTableModelRawHdr,
                        ...
                        isEqualCaseInsensitive(curTableModelRawHdr,
                                               YerithDatabaseTableColumn::
                                               LOCALISATION_SORTIE_ID)
                        && !YerithUtils::
                        isEqualCaseInsensitive(curTableModelRawHdr,
                                               YerithDatabaseTableColumn::
                                               LOCALISATION_ENTREE_ID))
                {
                    anItem =
...
void YerithERPMouvementsDeStocksTableView::selectionChanged(const QItemSelection &
                                                            selected,
                                                            ...
                                                            deselected)
{
    ...
    if (selectedIndexes.size() > 0)
    {
        ...
        {
            curAllWindows->
            _mouvementsDeStocksWindow->getQModelIndex_dbID_from_MODEL_INDEX
