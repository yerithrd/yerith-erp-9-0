/*
 * yerith-erp-achats-table-view.cpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */


#include "yerith-erp-achats-table-view.hpp"
...
void YerithERPAchatsTableView::lister_les_elements_du_tableau(YerithSqlTableModel
                                                              & tableModel)
{
    ...
    for (int i = 0; i < rows; ++i)
    {
        ...
        for (int k = 0; k < columns; ++k)
        {
            ...
            case QVariant::Int:
                ...
                else		//YerithDatabaseTableColumn::STOCKS_ID
                {
...
void YerithERPAchatsTableView::selectionChanged(const QItemSelection &selected,
