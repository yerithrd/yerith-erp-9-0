/*
 * yerith-erp-CHARGES-FINANCIERES-table-view.cpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */


#include "yerith-erp-CHARGES-FINANCIERES-table-view.hpp"
...
void YerithERP_CHARGES_FINANCIERES_TableView::
...
void YerithERP_CHARGES_FINANCIERES_TableView::selectionChanged(const QItemSelection &selected,
