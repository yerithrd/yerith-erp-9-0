/*
 * yerith-erp-article-vente-info.hpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */

#ifndef SRC_UTILS_YERITH_ARTICLE_VENTE_INFO_HPP_
#define SRC_UTILS_YERITH_ARTICLE_VENTE_INFO_HPP_
...
public:
    ...
    inline QString get_unite_de_Mesure()
    {
        return _unite_de_Mesure;
    }
...
#endif /* SRC_UTILS_YERITH_ARTICLE_VENTE_INFO_HPP_ */
