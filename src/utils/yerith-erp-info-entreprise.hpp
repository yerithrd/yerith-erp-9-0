/*
 * yerith-erp-info-entreprise.hpp
 *
 *      Author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */

#ifndef YERITH_INFO_ENTREPRISE_HPP_
#define YERITH_INFO_ENTREPRISE_HPP_
...
public:
    ...
    YERITH_CLASS_OPERATORS inline YerithInfoEntreprise()
    {
        updateInfoEntrepriseFromDB();
    }

    inline ~YerithInfoEntreprise()
    {
    }
    ...
    {
        return YerithUtils::LATEX_IN_OUT_handleForeignAccents(_nom_commercial);
    }
    ...
    {
        return YerithUtils::LATEX_IN_OUT_handleForeignAccents(_localisation);
    }
    ...
    {
        return YerithUtils::LATEX_IN_OUT_handleForeignAccents(_siege_social);
    }
    ...
    {
        return YerithUtils::LATEX_IN_OUT_handleForeignAccents(_ville);
    }
    ...
    {
        return YerithUtils::LATEX_IN_OUT_handleForeignAccents(_pays);
    }
    ...
    {
        return YerithUtils::LATEX_IN_OUT_handleForeignAccents(_email.toLower());
    }
    ...
    {
        return
                        YerithUtils::GET_STRING_WITH_NUMBERS_WITHIN_KEPT_FOR_LATEX(_telephone);
    }
    ...
    {
        return YerithUtils::GET_STRING_WITH_NUMBERS_WITHIN_KEPT_FOR_LATEX
    ...
    {
        return
                        YerithUtils::LATEX_IN_OUT_handleForeignAccents(_agence_comptebancaire);
    }
    ...
    {
        return
                        YerithUtils::LATEX_IN_OUT_handleForeignAccents(_secteurs_activites);
    }
...
#endif //YERITH_INFO_ENTREPRISE_HPP_
