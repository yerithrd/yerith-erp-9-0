...
YerithERPUserSettings::~YerithERPUserSettings()
{
...
RESULT_PRINTING_PARAMETER YerithERPUserSettings::
							   	   	    ...
							   	   	    YerithWindowsCommons *a_current_window_to_table_print_as_parameter /* = 0 */)
{
    ...
    do
    {
        ...
        if (!line.isEmpty())
        {
            list =
                            line.split
                            (YERITH_ERP_3_0_CONFIGURATION_FILE_SEPARATION_OPERATOR);
							   ...
							   YerithWindowsCommons *a_current_window_to_table_print_as_parameter /* = 0 */)
{
    ...
    YerithIMPRESSION_DE_DOCUMENT_Dialog *impressionDeDocumentDialog =
                    allWindows->_impressionDeDocumentDialog;

    if (0 == impressionDeDocumentDialog)
    {
        //              QDEBUG_STRING_OUTPUT_1("YERITH-PP-1-failed");
        return READ_PRINTING_PARAMETER_FAILED;
    }

    YerithWindowsCommons *a_current_window_to_print_table =
    ...
    if (0 == a_current_window_to_print_table)
    {
        if (0 != a_current_window_to_table_print_as_parameter)
        {
            //                      QDEBUG_STRING_OUTPUT_1("YERITH-PP-2-success-initialization");
    ...
    QString a_current_window_object_name =
                    YERITH_QT_OBJECT_NAME(a_current_window_to_print_table);
		 ...
		 enum RESULT_PRINTING_PARAMETER a_result_printing_parameter /* = READ_PRINTING_PARAMETER_SUCCESSFUL */)
{
    ...
    if (0 != allWindows)
    {
        ...
        if (0 != impressionDeDocumentDialog)
        {
            ...
            if (0 != a_current_window_to_print_table)
            {
                YerithLineEdit *a_yerith_line_edit_nombre_de_pages =
                                a_current_window_to_print_table->
                ...
                if (0 != a_yerith_line_edit_nombre_de_pages)
                {
                    aUserSQLTableRowCount_STRING =
                                    a_yerith_line_edit_nombre_de_pages->text();
...
bool YerithERPUserSettings::
	enregistrer_les_parametres_locaux__QTABLEWIDGET
		(const QString 					&user_local_personal_setting_full_file_path,
		 YerithWindowsCommons 			*a_current_window_to_table_print_as_parameter,
		 enum RESULT_PRINTING_PARAMETER a_result_printing_parameter /* = READ_PRINTING_PARAMETER_SUCCESSFUL */)
{
    //      _logger->log("enregistrer_les_parametres_locaux");
    //      QDEBUG_STRING_OUTPUT_2("user_local_personal_setting_full_file_path", user_local_personal_setting_full_file_path);
