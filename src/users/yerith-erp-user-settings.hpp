/*
 * yerith-erp-user-settings.hpp
 *
 * @author: Pr. Prof. Dr.-Ing. Xavier Noundou
 */

#ifndef SRC_USER_YERITH_ERP_3_0_USER_SETTINGS_HPP_
#define SRC_USER_YERITH_ERP_3_0_USER_SETTINGS_HPP_
...
public:
    ...
    {
        _logger = new YerithLogger(QString("YerithERPUserSettings"));
    }


    virtual ~YerithERPUserSettings();
    ...
    {
        QDEBUG_STRING_OUTPUT_2("YerithERPUserSettings::PRINT_PARAMETERS_TO_STRING()",
...
#endif /* SRC_USER_YERITH_ERP_3_0_USER_SETTINGS_HPP_ */
