...
bookmarks,
plainpages=false,
pdftitle={Fiche du client YERITHCLIENT, pour l'entreprise 'YERITHENTREPRISE'.},
...
\section*{\underline{Fiche du client:} 'YERITHCLIENT'}
...
\caption*{L'image associ\'ee au client 'YERITHCLIENT'}
}
\end{tabular}
\end{table}
