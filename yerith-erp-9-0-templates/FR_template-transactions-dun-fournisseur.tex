...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Transactions du YERITHVENTESDEBUT au YERITHVENTESFIN (Fournisseur ''YERITHFOURNISSEUR''),
         	  imprim\'e par: ''YERITHNOMUTILISATEUR''.},
...
\section*{Transactions FINANCIÈRES du YERITHVENTESDEBUT au YERITHVENTESFIN (Fournisseur ''YERITHFOURNISSEUR'')}

\textbf{Imprim\'e par:} YERITHNOMUTILISATEUR\\
\textbf{SUCCURSALE DE GÉNÉRATION DU FICHIER.:} YERITHSUCCURSALE\\
\textbf{Devise financière (monnaie):} YERITHDEVISEFINANCIEREMONNAIE\\
