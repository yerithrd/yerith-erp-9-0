...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={$1$ liste des programmes de FID\'ELIT\'E CLIENTS imprim\'ee
    	par YERITHNOMUTILISATEUR (YERITHENTREPRISE, YERITHDATE)},
...
\section*{$1$ LISTE DES PROGRAMMES DE FID\'ELIT\'E CLIENTS}
