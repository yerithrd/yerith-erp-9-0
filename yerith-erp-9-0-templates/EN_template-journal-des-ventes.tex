...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Journal of sales from YERITHVENTESDEBUT
       to YERITHVENTESFIN printed by YERITHNOMUTILISATEUR (YERITHENTREPRISE)},
...
\section*{Journal of sales from YERITHVENTESDEBUT to YERITHVENTESFIN}
