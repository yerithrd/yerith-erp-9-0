...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Historique YERITHHISTORYSTOCKASSET ''YERITHSTOCKHISTORYDESIGNATION'' avec le ID: ''YERITHSTOCKID'',
...
\section*{Historique YERITHHISTORYSTOCKASSET ''YERITHSTOCKHISTORYDESIGNATION'' avec le ID: ''YERITHSTOCKID''}

\textbf{R\'ef\'erence du stock:} YERITHSTOCKHISTORYREFERENCE\\
