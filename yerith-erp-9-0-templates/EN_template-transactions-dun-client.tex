...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Transactions of Customer 'YERITHCLIENT' from YERITHVENTESDEBUT to YERITHVENTESFIN,
...
\section*{FINANCIAL Transactions of Customer 'YERITHCLIENT' from YERITHVENTESDEBUT to YERITHVENTESFIN}
