...
bookmarks,
plainpages=false,
pdftitle={Re\c{c}u pour le client YERITHCLIENT, YERITHENTREPRISE},
...
\section*{\underline{Re\c{c}u}: YERITHNUMEROSORTIETRANSFERT}
\textbf{Heure de vente:} YERITHHEUREVENTE\\
\textbf{Type de paiement}: YERITHPAIEMENT\\
\textbf{Boutique de vente}: YERITHLOCALISATION_SORTIE\\
