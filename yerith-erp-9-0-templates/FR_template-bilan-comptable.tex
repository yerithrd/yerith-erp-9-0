...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Bilan comptable du YERITHBILANCOMPTABLEDEBUT
       au YERITHBILANCOMPTABLEFIN imprim\'e par YERITHNOMUTILISATEUR (YERITHENTREPRISE)},
...
\begin{table}[!htbp]
\begin{tabular}{lrr}
achats d'immobilisations					& YERITHBILANCOMPTABLEACHATSimmobilisationDEVISE		& \\
