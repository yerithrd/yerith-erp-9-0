...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={La fiche des marchandises (SERVICES) imprim\'ee par YERITHNOMUTILISATEUR (YERITHENTREPRISE, YERITHDATE)},
...
\section*{Fiche des Marchandises YERITHMARCHANDISESNONTERMINEES (SERVICES)}
