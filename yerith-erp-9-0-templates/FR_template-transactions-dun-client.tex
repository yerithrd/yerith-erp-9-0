...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Transactions du YERITHVENTESDEBUT au YERITHVENTESFIN (Client ''YERITHCLIENT''),
...
\section*{Transactions FINANCIÈRES du YERITHVENTESDEBUT au YERITHVENTESFIN (Client ''YERITHCLIENT'')}
