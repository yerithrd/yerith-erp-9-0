...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={History of YERITHHISTORYSTOCKASSET ''YERITHSTOCKHISTORYDESIGNATION'' with ID: ''YERITHSTOCKID'',
...
\section*{History of YERITHHISTORYSTOCKASSET ''YERITHSTOCKHISTORYDESIGNATION'' with ID: ''YERITHSTOCKID''}

\textbf{Stock reference:} YERITHSTOCKHISTORYREFERENCE\\
