...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={EMPLOYEE PAY GROUP list printed by YERITHNOMUTILISATEUR (YERITHENTREPRISE, YERITHDATE)},
...
\headerrow
	...
	{\emph{\textbf{Num\'ero de contribuable:} YERITHCONTRIBUABLENR}}
\headerrow
	{\emphbold{YERITHACTIVITESENTREPRISE}}
	{\emph{\textbf{Num\'ero de compte bancaire:} YERITHCOMPTEBANCAIRENR,}}
\headerrow
...
\section*{EMPLOYEE PAY GROUP LIST}
