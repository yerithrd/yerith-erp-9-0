...
\newpsstyle{diagbgframestyle}{linewidth=1pt,linecolor=black,fillcolor=yerithColorGray}
...
\drawlevellines
    ...
    %
    %\renewcommand{\legendShadowColor}{yerithColorGray}
    %
    \diagLegendbegin{12}{882}{9}
      \diagLegenditem{YERITHBASELEGEND}{\onecol}
      \diagLegenditem{YERITHTOPLEGEND}{\onetopcol}
    \diagLegendend
    % End of the legend
\setlength{\captionoffset}{2cm}
\bardiagramend{\parbox{11cm}{{\centering \vspace{2.5cm} YERITHX\\[0.3cm] 
   \hspace{0cm}
   \begin{tabular}{p{3.2cm}p{4.0cm}p{3.2cm}}
      \centering YERITHONE & \centering YERITHTWO & \centering YERITHREE
   \end{tabular}
   \vspace{-0.3em}
  }}}
  {\large YERITHZ}
