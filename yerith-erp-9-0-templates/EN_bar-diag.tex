...
\hypersetup{
    ...
    pdftitle={Diagram illustrating the income from
		YERITHCHIFFREAFFAIREDATEDEBUT to YERITHCHIFFREAFFAIREDATEFIN
...
\section*{Diagram illustrating the income from YERITHCHIFFREAFFAIREDATEDEBUT
		  to YERITHCHIFFREAFFAIREDATEFIN YERITHMENTION}
