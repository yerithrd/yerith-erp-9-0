...
bookmarks,
plainpages=false,
pdftitle={FACTURE CLIENT - YERITHVENTECOMPTECLIENTREFERENCEINVOICEFACTURE pour le client YERITHCLIENT, YERITHENTREPRISE},
...
Total TTC 	 \\
 & & & & & & \\
\hline
YERITHFACTUREINVOICEPRODUCTREFERENCE & 
YERITHFACTUREINVOICEPRODUCTNAME 	 & 
YERITHFACTUREINVOICECATEGORY 	 	 & 
YERITHFACTUREINVOICESALEQUANTITY     & 
YERITHFACTUREINVOICEUNITPRICE 	 	 &
YERITHFACTUREINVOICETAX 		 	 & 
YERITHFACTUREINVOICETOTALATC 		 \\ \hline
\multicolumn{2}{|c}{TOTAL} 	  		 & 
									 & 
YERITHFACTUREINVOICESALEQUANTITY 	 & 
									 & 
YERITHFACTUREINVOICETAX 		  	 & 
YERITHFACTUREINVOICETOTALWITHCURRENCYATC 	\\ \hline 
\end{tabular}}
\end{table*}
