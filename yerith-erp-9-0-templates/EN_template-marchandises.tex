...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Merchandise (SERVICE) inventory printed by YERITHNOMUTILISATEUR (YERITHENTREPRISE, YERITHDATE)},
...
\section*{Merchandise (SERVICE) Inventory YERITHMARCHANDISESNONTERMINEES}
