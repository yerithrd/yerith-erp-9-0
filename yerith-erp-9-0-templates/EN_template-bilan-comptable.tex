\documentclass[10pt,YERITHPAPERSPEC,landscape]{article} % use larger type; default would be 10pt
...
\hypersetup{
    ...
    bookmarks,
    plainpages=false,
    pdftitle={Financial accounting report from YERITHBILANCOMPTABLEDEBUT
       to YERITHBILANCOMPTABLEFIN printed by YERITHNOMUTILISATEUR (YERITHENTREPRISE)},
...
\begin{table}[!htbp]
\begin{tabular}{lrr}
ASSET purchase 				&  YERITHBILANCOMPTABLEACHATSimmobilisationDEVISE			& \\
